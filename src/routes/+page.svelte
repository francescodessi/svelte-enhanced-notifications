<script>
    ...
    $: customWidth = customStyle ? 100 : undefined;
    ...
    function showNotification() {
        notficationService?.push({
            ...
            customWidth: customWidth != null ? `${customWidth}%` : undefined,
        });
    }
</script>
        ...
        {#if customStyle}
            <div transition:fade>
                ...
                <div>
                    <label for="width">
                        Width {customWidth}%
                        <input type="range" id="width" name="width" bind:value={customWidth} min="0" max="100" disabled={!customStyle}>
                    </label>
                </div>
